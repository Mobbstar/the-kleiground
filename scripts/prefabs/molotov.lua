local molotov_assets = {
    Asset("ANIM", "anim/molotov.zip"),
    Asset("ANIM", "anim/swap_molotov.zip"),
	
    Asset("ATLAS", "images/inventoryimages/molotov.xml"),
    Asset("IMAGE", "images/inventoryimages/molotov.tex"),
}
 
local molotov_prefabs = {
    "explode_small",
}
...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_molotov", "swap_molotov")
...
local function molotov_fn()
    local inst = common_fn("molotov", "molotov", "idle", "projectile", true)
    ...
    inst.components.inventoryitem.imagename = "molotov"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/molotov.xml"
