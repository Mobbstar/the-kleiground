...
local STRING_LISTS = {}
for k, v in pairs(STRINGS.EYELANDER) do
...
local TALK_SOUNDS =
{
    "demoman/demoman/eyelander_talk",
}
...
local function OnEntityReplicated(inst)
    ...
    if inst._parent == nil then
        print("Unable to initialize classified data for Cesar.")
    else
...
return Prefab("cesarshank_classified", fn)
