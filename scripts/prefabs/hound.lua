local PickNewName = require "NPC_stringskg"
...
local function fncommon(build, morphlist)
    ...
    inst.components.named.possiblenames = STRINGS.HOUNDNAMES
...
if observer.prefab == "wobert" then

return -TUNING.SANITYAURA_LARGE*5
