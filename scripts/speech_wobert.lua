return {
	...
	ANNOUNCE_NOHUNGERSIESTA = "You have a meal and THEN take a siesta.",
	ANNOUNCE_SHELTER = "I could stay here a while.",
	ANNOUNCE_BURNT = "Ow!",
	ANNOUNCE_TOOL_SLIP = "Drat.",
	ANNOUNCE_DAMP = "Maybe it'll wash out my bandanna.",
	ANNOUNCE_WET = "Now it's a bit uncomfortable.",
	ANNOUNCE_WETTER = "My hand wraps are falling off.",
	ANNOUNCE_SOAKED = "This is ridiculous.",
	ANNOUNCE_ADVENTUREFAIL = "I'll get revenge.",
	ANNOUNCE_BEES = "Bees!",
	ANNOUNCE_BOOMERANG = "Aaah!",
	ANNOUNCE_CHARLIE = "Who's there?",
	ANNOUNCE_CHARLIE_ATTACK = "Aaah!",
	ANNOUNCE_COLD = "I've lost feeling in my body...",
	ANNOUNCE_HOT = "This heat... is too much!",
	ANNOUNCE_CRAFTING_FAIL = "Er... I can't do that.",
	ANNOUNCE_DEERCLOPS = "I hear one of them coming.",
	ANNOUNCE_DUSK = "Might as well head back to camp now.",
	ANNOUNCE_EAT =
	{
		GENERIC = "(Gulp!)",
		PAINFUL = "Aah! My insides!",
		SPOILED = "Euuugh!",
		STALE = "Gross.",
		INVALID = "I won't let that anywhere near my mouth.", 
		YUCKY = "I have a heartier appetite than that.", 
	},
	ANNOUNCE_ENTER_DARK = "Keep it together, Shank.",
	...
	COMBAT_QUIT =
	{
		GENERIC = "Tell your friends they're next.",
		PIG = "Next time, pig!",
	...
	PLAYER =
		...
		MARIA = 
		{
			GENERIC = "%s doesn't like my direct approach of things.",
			ATTACKER = "A bit hypocritical, don't you think, Miss %s?",
			MURDERER = "I'll lead this group better, %s.",
			REVIVER = "You're alright, I guess.",
			GHOST = "Is this the freedom you were fighting for, %s?",
		},
		DECKER = 
		{
			GENERIC = "%s, have we met?",
			ATTACKER = "%s, we can't just kill people like this.",
			MURDERER = "That's it! I'll just take you out myself, %s.",
			REVIVER = "You're alright, I guess.",
			GHOST = "%s is going to need some help.",
		},
		WOBERT = 
		{
			GENERIC = "This is a sick joke, %s.",
			ATTACKER = "%s is making me look bad. I don't like looking bad.",
			MURDERER = "How about you fight me next, %s?",
			REVIVER = "Are you trying to replace me? I can help people too.",
		...
		WOLFGANG = 
		{
			GENERIC = "%s reminds me of an old friend of mine.",
		...
		WAXWELL = 
		{
			GENERIC = "Don't think I'm not onto you, %s.",
		...
		BERRYBUSH =
		{
			...
			WITHERED = "Nothing up here seems to handle heat well.",
		...
		BIRDCAGE =
		{
			GENERIC = "It's not just for decoration.",
			OCCUPIED = "Feels bad to be forced into something.",
			SLEEPING = "Glad you can rest easy.",
			HUNGRY = "That bird is looking thinner than normal.",
			STARVING = "Looking rather skeletal now.",
			DEAD = "Nasty. It's egun to bloat.",
			SKELETON = "So that's where the odor's coming from.",
		},
		...
		BLOWDART_FIRE = "I suppose this will have to replace Molotovs.",
		BLOWDART_SLEEP = "A tranquilizer dart.",
		BLOWDART_PIPE = "I'll save these for faster targets.",
		BLUEAMULET = "It's frosted over.",
		BLUEGEM = "Blue brings ice.",
		BLUEPRINT = "Maybe that'll be useful.",
		BELL_BLUEPRINT = "Interesting. Who wrote this?",
		...
		GEARS = "I'm not a mechanic.",
		GHOST = "Eva? Is that you?",
